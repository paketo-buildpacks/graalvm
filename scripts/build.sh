...
GOOS="linux" go build -ldflags='-s -w' -o bin/build github.com/paketo-buildpacks/graalvm/cmd/build
GOOS="linux" go build -ldflags='-s -w' -o bin/class-counter github.com/paketo-buildpacks/libjvm/cmd/class-counter
GOOS="linux" go build -ldflags='-s -w' -o bin/detect github.com/paketo-buildpacks/graalvm/cmd/detect
